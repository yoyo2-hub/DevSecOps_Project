...
public class ProductEntity {
     ...
     */
    public ProductEntity(Long id, String name, String description, BigDecimal price, String imageUrl, String category, int quantity) {
        this.id = id;
        this.name = name;
     ...
     */
    public ProductEntity(String name, String description, BigDecimal price, String imageUrl, String category, int quantity) {
        this.name = name;
        this.description = description;
        this.price = price;
        this.imageUrl = imageUrl;
